...
Общее количество тестов составило с ?, из них с позитивными сценариями ?, с негативными - ?. 
? тестов завершились с отрицательным результатом, что составляет ?% от общего количества.
